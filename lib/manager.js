...
internals.Manager.prototype.render = function (filename, context, options, request, callback) {
    ...
    if (!callback) {
        return internals._wrapMethod(this, this.render, [filename, context, options, request]);
    }
